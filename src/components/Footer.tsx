    ...
    <footer className="footer">
      <div className="container footer-container">
        ...
        <div className="footer-links-col">
          <h4>Services</h4>
          <ul>
            <li><Link to="/products">Web Application Development</Link></li>
            <li><Link to="/products">Cloud Solutions</Link></li>
            <li><Link to="/products">Database Optimization</Link></li>
            <li><Link to="/products">Technical Consulting</Link></li>
          </ul>
        </div>
      </div>
      ...
      <div className="container">
        <div className="footer-bottom">
          <div className="footer-copy">
            © {currentYear} Coding With God. All rights reserved.
          </div>
          <div style={{ display: 'flex', alignItems: 'center', gap: '4px', fontSize: '0.85rem', color: 'var(--text-muted)' }}>
            Made with <Heart size={12} fill="#ef4444" color="#ef4444" /> for a better digital world.
          </div>
